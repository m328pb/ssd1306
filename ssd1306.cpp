...
void oled::initialize() {
  ...
  static const uint8_t PROGMEM init[] = {
      ...
      0x02, // Alternative COM pin configuration (sequencial COM pin +
            // left/right remap)
      ...
      0xA4, // Set entire display on/off (0xA4 normal mode, 0xA5 entire display
            // on)
      ...
      0xAF}; // display on
  cmd(init, sizeof(init) / sizeof(init[0]), true);
  clear();
}
